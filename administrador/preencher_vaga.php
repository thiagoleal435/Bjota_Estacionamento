...
<head>
    ...
    <title>Preencher Vaga | BJota Estacionamento</title>
...
<body>
    ...
    <div class="container">
        ...
        <div class="container-interno">
            ...
            <form class="card" method="POST" action="teste_vaga_adm.php">
                <div class="tr">
                    <label for="cpfcliente">CPF do cliente</label>
                    <input type="number" id="cpfcliente" name="cpfcliente" placeholder="CPF" max="99999999999" required>
                ...
                ?>
                    ...
                    <label for="vagas">Digite o número da vaga que irá ocupar</label>
